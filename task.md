* [X] ~~*Cambiar la repeticion del el layout en dos paginas, utiliza otros elementos que no sean si o si cards en el sitio.*~~ [2025-03-17] 
* [X] ~~*falta la implementacion de 1 html, recorda que son 5.*~~ [2025-03-17] 
* [ ] NO utilizaste ni flex ni grid en el proyecto. 
* [ ] También faltó el uso de media queries. No es ideal trabajar todo con bootstrap, arma layouts con codigo propio. Realiza los cambios para la proxima entrega.
...
2. Archivo CSS, Archivos SCSS (en GitHub)
